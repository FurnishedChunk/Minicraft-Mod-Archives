...
- ![PirateGarden - 0.6 / Multiple Class files are missing](https://github.com/FurnishedChunk/Minicraft-Mod-Archives/raw/master/Minicraft%20Mods/PirateGarden/PirateGarden06.zip)  

*Many Class files are missing, so it won't start as is.
